...
export const personalInfo = {
  ...
  tagline:
    "Full Stack Developer | Mastering MERN Stack | Crafting Modern Web Solutions",
  socialLinks: {
...
export const projects = [
  ...
  },
  {
    ...
    title: "Sticky Notes",
    description:
      "A web app for organizing thoughts, ideas, and reminders in a simple and intuitive way.",
    image: null, // Will add later
  ...
  },
  {
    ...
    title: "Matrix Solver",
    description:
      "A web application for performing various operations on matrices.",
    image: null, // Will add later
    techStack: ["HTML", "CSS", "JavaScript"],
  ...
  },
  {
    ...
    description:
      "A classic game brought to life with HTML, CSS, and JavaScript.",
    image: null, // Will add later
    techStack: ["HTML", "CSS", "JavaScript"],
  ...
  },
  {
    ...
    title: "Speak Genie",
    description:
      "A platform to convert audio input into text and transform text back into audio.",
    image: null, // Will add later
  ...
  },
  {
    ...
    title: "Todo App",
    description:
      "A basic ToDo app to keep track of tasks using HTML, CSS, and JavaScript.",
    image: null, // Will add later
  ...
  id: 8,
  title: "LinkWeb",
description: "A MERN app with full auth where users create and share customizable profile cards with personal and social links.",
  image: null, // Will add later
  techStack: ["React", "ExpressJS", "MongoDB", "NodeJS", "TailwindCSS", "Clerk"],
  liveLink: "https://link-web-ui.netlify.app/",
  github: "https://github.com/devmulkalwar/linkweb"
},
{
    id: 9,
    title: "PseudoAPI",
    description:
      "A mock API generator for frontend developers to create customizable GET endpoints with realistic, dynamic data using FakerJS.",
    image: null, // Will add later
    techStack: [
      "React",
      "TailwindCSS",
    ...
    liveLink: "https://pseudo-api.netlify.app/",
    github: "https://github.com/devmulkalwar/pseudo-api",
  },
];
